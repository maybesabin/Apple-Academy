            ...
            <section className='w-[90rem] flex flex-col items-center h-full justify-start gap-[5rem]'>
                ...
                <div className="flex flex-col items-start justify-start gap-12">
                    {questions.map((item, index) => {
                        return (
                            <Accordion key={index} type="single" className="lg:w-[850px] md:w-[500px] w-[350px] text-left" collapsible>
                                <AccordionItem value="item-1">
                                    <AccordionTrigger className="md:text-2xl text-[1rem] text-left">{item.question}</AccordionTrigger>
                                    <AccordionContent className="text-[#c3c9e9] md:text-xl text-xs">
                                        {item.answer}
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
