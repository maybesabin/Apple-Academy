...
const Accordions = () => {
    return (
        <div id="programs" className='bg-[#373f47] text-white flex items-center py-[7rem] justify-center w-full'>
            <section className='w-[90rem] flex flex-col items-center h-full justify-start gap-[5rem]'>
                <div className='flex items-center flex-col justify-start md:gap-2 gap-0'>
                    <h1 className='md:text-7xl text-5xl font-extralight'>FAQs</h1>
                ...
                <div className="flex flex-col items-start justify-center w-[500px] gap-12">
