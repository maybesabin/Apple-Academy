  ...
  return (
    <div id='home' className='relative'>
      ...
      <section className='flex lg:flex-row flex-col items-center lg:justify-evenly justify-center lg:h-[110vh] w-screen lg:py-0 pt-[10rem] pb-[5rem]'>
        ...
        <div className='z-[998] md:text-7xl text-[2.5rem] leading-[2.5rem] flex flex-col lg:items-start items-center justify-center lg:gap-[5rem] gap-9 h-auto lg:w-[35%] w-1/2'>
          ...
          <div className='flex flex-col lg:items-start items-center justify-center gap-1 lg:w-full w-screen'>
            ...
            <p className='pt-6 md:px-0 px-4 lg:text-left text-center md:text-[1rem] text-xs opacity-75 italic w-full'>Nurturing curiosity, fostering independence, and igniting a lifelong love of learning.</p>
          </div>
